...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed inset-0 z-50 flex flex-col rounded-none bg-white p-6 shadow-lg max-h-[85dvh] overflow-y-auto w-full',
        'sm:fixed sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:inset-auto sm:rounded-xl sm:max-w-lg',
